...
//    private Category bookConlection;
    ...
    public Book( String bookName, int total, int quantity, String status, String authorName, Date date, int numberPages, Float borrowTime, String imageBook, Category category, Cart cart, Borow borow) {
//        this.bookId = bookId;
